...
def extract_date_scraped(mep_name):
    ...
    snapshot_info_path = f"C:/Users/Emilia/Documents/Uni Helsinki/Year Three/AMO Freelance/assistant task/9 term/raw data/scraped assistant html pages/{mep_name}/snapshot_info.txt"
