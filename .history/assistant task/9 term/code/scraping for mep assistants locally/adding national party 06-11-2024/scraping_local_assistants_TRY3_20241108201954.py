...
class MEP:
    ...
    def get_mep_data(self):
        try:
            ...
            if not group_tag:
                group_tag = soup.find('div', class_='erpl-political-group-name')
            if not group_tag:
                group_tag = soup.find('span', class_='ep_group-name')
            ...
            if self.group:
                print(f"Found MEP group: {self.group}")  # Debug print
            else:
                print("MEP group not found.")  # Debug print
