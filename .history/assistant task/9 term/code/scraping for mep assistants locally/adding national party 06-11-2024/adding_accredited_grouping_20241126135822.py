    ...
    def get_mep_data(self):
        try:
            ...
            for section in assistants_section:
                # Extract the type of assistants based on the header
                ...
                if assistant_type_tag:
                    ...
                    continue  # If no header found, skip this section
                
                if assistant_type not in self.assistants:
                    self.assistants[assistant_type] = []

                # Extract the assistant names
                assistant_tags = section.find('span', class_='erpl_assistant')
