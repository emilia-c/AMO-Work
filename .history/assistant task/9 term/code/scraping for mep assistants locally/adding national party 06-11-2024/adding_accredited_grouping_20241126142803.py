...
class MEP:
    ...
    def get_mep_data(self):
        try:
            ...
            country_party_tag = soup.find_all('div', class_='erpl_title-h3 mt-1 mb-1')
            ...
            # Inside the existing method to find assistants in the first structure
            assistants_sections = soup.find('div', class_='ep_gridcolumn-content')
            if assistants_sections:
                for section in assistants_sections.find_all('section'):
                    ...
                    print(f"Found assistant type: {assistant_type}")  # Debugging line
            ...
            # Same debug for the second structure
            assistants_section = soup.find('div', class_='erpl_type-assistants')
            if assistants_section:
                for section in assistants_section.find_all('section'):
