...
# Now, update the missing_htmls.explanation.txt file if URL is missing
updated_lines = []

for line in lines:
    if line.startswith("URL:") and not line.strip().endswith("URL AVAILABLE"):
        # Check if the URL section is missing or empty, add "NO ARCHIVED URL AVAILABLE"
...
print(f"\nMissing URLs have been updated in {file_missing_htmls}.")
